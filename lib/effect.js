...
var store = require('@methodjs/store');
...
function createEffect(effect, options) {
    ...
    var _d = store.createStore(initializeStore, {
        key: key,
    }), useStore = _d[0], setStore = _d[1], getStore = _d[2];
    var _e = store.createStore(initializeEffectState), useState = _e[0], setState = _e[1], getState = _e[2];
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        setState(function (value) { return (tslib.__assign(tslib.__assign({}, value), { isLoading: true })); });
                        if (notUsedCache !== true &&
                            ...
                            if (cacheLimitTime > new Date()) {
                                setState(function (value) { return (tslib.__assign(tslib.__assign({}, value), { error: null, isLoading: false, isFromCache: true })); });
                            }
                            return [2 /*return*/];
                        }
                        _b.label = 1;
                    ...
                    case 2:
                        ...
                        if (isPreventCache === true) {
                            setState(function (value) { return (tslib.__assign(tslib.__assign({}, value), { error: null, isLoading: false, isFromCache: false })); });
                        }
                        else {
                            setState(function (value) { return (tslib.__assign(tslib.__assign({}, value), { error: null, isLoading: false, cachedTime: new Date(), isFromCache: false })); });
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _b.sent();
                        setState(function (value) { return (tslib.__assign(tslib.__assign({}, value), { error: error_1, isCanceled: true, isLoading: false })); });
                        return [3 /*break*/, 4];
    ...
    var startReact = store.createBehavior(function (key) {
